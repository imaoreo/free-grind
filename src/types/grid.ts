...
export const browseCardSchema = z.object({
	...
	isVisiting: z.boolean().nullable().optional(),
	isBoosting: z.boolean().nullable().optional(),
	unreadCount: z.number().optional(),
	favorite: z.boolean().nullable().optional(),
	chatted: z.boolean().nullable().optional(),
...
export const profileDetailItemSchema = z.object({
	...
	displayName: z.string().nullable().optional(),
	age: z.number().nullable().optional(),
	showAge: z.boolean().nullable().optional(),
	onlineUntil: z.number().nullable().optional(),
	...
	approximateDistance: z.boolean().nullable().optional(),
	showDistance: z.boolean().nullable().optional(),
	...
	medias: z
		...
		.transform(v => v ?? []),
	profileImageMediaHash: z.string().nullable().optional(),
	tapped: z.boolean().nullable().optional(),
	tapType: z.union([z.number(), z.boolean()]).nullable().optional(),
	lastReceivedTapTimestamp: z.number().nullable().optional(),
	isTeleporting: z.boolean().nullable().optional(),
	isRoaming: z.boolean().nullable().optional(),
	...
	showPosition: z.boolean().nullable().optional(),
	...
	showTribes: z.boolean().nullable().optional(),
	tribesImInto: z.array(z.number()).nullable().optional().transform(v => v ?? []),
	showVipBadge: z.boolean().nullable().optional(),
	...
	travelPlans: z
		...
		.optional()
		.transform(v => v ?? []),
	isInAList: z.boolean().nullable().optional(),
	socialNetworks: z
		.object({
			instagram: z
