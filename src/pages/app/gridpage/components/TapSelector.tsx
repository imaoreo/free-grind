...
export function TapSelector({
	...
	return (
		...
		>
			...
			<div
				className={`tab-menu select-none touch-none absolute z-[60] flex items-center gap-8 rounded-full border border-white/10 px-10 py-6 shadow-xl ${compact ? "bottom-full left-1/2 mb-2 -translate-x-1/2" : "bottom-full left-1/2 mb-4 -translate-x-1/2"} ${showTapPicker ? "active" : ""}`}
			>
				{[1, 2, 0].map((id) => (
					<div
						key={id}
