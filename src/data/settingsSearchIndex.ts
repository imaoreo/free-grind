...
export function useSettingsSearchIndex(): SettingsSearchEntry[] {
	...
	return useMemo<SettingsSearchEntry[]>(() => [
		...
		{
			id: "nav-saved-phrases",
			route: "/settings/saved-phrases",
			label: t("settings.saved_phrases", { defaultValue: "Saved Phrases" }),
			description: t("settings.saved_phrases_desc", { defaultValue: "Manage chat quick replies and import/export .txt" }),
			section: "Chat",
			icon: Bookmark,
